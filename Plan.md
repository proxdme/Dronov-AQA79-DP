...
1.73 ввод месяца больше 12 (например 13):
   ...
   Ввод данных карты в поле месяц со знаечением больше 12.\
   Ожидаемое сообщение об ошибке на экране (Неверный формат).
...
1.75 ввод месяца в неверном формате (ХХ, например вместо 04 - 4):
   ...
   Ввод номер карты из списка 4441.\
   Ввод месяца одним цифрой например 4.\
   Переход на следующее поле формы (год).\
   Ожидаемое сообщение об ошибке на экране (Неверный формат).
...
1.78 пустое поле знаечения года:
   ...
   Ввод номер карты из списка 4441.\
   Ввод текущего месяца карты.\
   Пустое поле ввода значения года карты.\
   Переход на следующее поле формы (Владелец).\
   Ожидаемое сообщение об ошибке на экране (Поле обязательно для заполнения).
...
1.83 поле CVC пусто:
   ...
   Ввод текущего месяца карты.\
   Ввод текущего года карты.\
   Ввод данных Владельца карты например Ivan Ivanov.\
